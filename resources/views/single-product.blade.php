                ...
                <div class="single-product-image thumb-right">
                    ...
                    <div class="tab-content">
                        <div id="single-image-1" class="tab-pane fade show active big-image-slider">
                            <div class="big-image"><img class =""src="assets/images/uploads/{{$product->productImage}}"alt="Big Image"><a href="assets/images/single-product/big-1.png" class="big-image-popup"><i class="fa fa-search-plus"></i></a></div>
                        </div>
